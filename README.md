This repo is maintained to support the [OWS project](https://github.com/owstack). The [ows-release](https://github.com/owstack/ng-annotate/tree/ows-release) branch
adds a module namespace annotation feature useful when used with [angular-namespacer](https://github.com/callmehiphop/angular-namespacer).
